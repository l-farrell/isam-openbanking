...
from .federation.securitytokenservice import SecurityTokenServiceChainTemplates
from .federation.securitytokenservice import SecurityTokenServiceChainInstances
...
class Federation9070(Federation9060):
    ...
    def __init__(self, base_url, username, password):
            ...
            self.sts_templates = SecurityTokenServiceChainTemplates(base_url, username, password)
            self.sts_chains = SecurityTokenServiceChainInstances(base_url, username, password)
